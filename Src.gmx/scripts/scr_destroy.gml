...
if(image_xscale == -1){
 for(i=block_width;i<=abs(sprite_width);i+=block_width;)
 {
  ...
  ins               = instance_create((x-sprite_xoffset)-abs(sprite_width)+i, (y-sprite_yoffset)+i2, par_collapsing_terrain_tiles);
  with(ins)
  {
 ...
 else if(image_xscale == 1)
 {
  for(i=sprite_width-block_width;i>=0;i-=block_width;)
  {
   ...
   ins               = instance_create((x-sprite_xoffset)+i, (y-sprite_yoffset)+i2, par_collapsing_terrain_tiles);
   with(ins)
   {
