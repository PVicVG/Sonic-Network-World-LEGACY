...
//  All of Sonics Animations are stored here:
  ...
  // Idle Animation (Standing)
     if(Animation = "IDLE"){
        AnimationSprite      = spr_robotnik_idle;
        AnimationStart       = 0;
        AnimationEnd         = 0;
        AnimationLoop        = 0;
        AnimationSpeed       = 0;
  ...
  // Walk Animation            
     if(Animation = "WALK"){
        AnimationSprite      = spr_robotnik_walk;
        AnimationStart       = 0;
        AnimationEnd         = 7;
        AnimationLoop        = 0;
  ...
  // Jump/Roll Animation            
     if(Animation = "ROLL"){
        AnimationSprite      = spr_robotnik_jump;         
        AnimationStart       = 0;
        AnimationEnd         = 7;
        AnimationLoop        = 0;
        AnimationSpeed       = 0.2;
  ...
  // Transforming:
     ...
     // Fly Animation            
     if(Animation = "FLY"){
        AnimationSprite      = spr_robotnik_fly;     
        AnimationStart       = 0;        
        AnimationEnd         = 4;
        AnimationLoop        = 0;
        AnimationSpeed       = 0.25;
  ...
  // Fly exhausted Animation            
     if(Animation = "FLY_EXHAUSTED"){
        AnimationSprite      = spr_robotnik_fly_tired;     
        AnimationStart       = 0;        
        AnimationEnd         = 4;
        AnimationLoop        = 0;
      ...
      // CHARGE Animation            
     if(Animation = "CHARGE"){
        AnimationSprite      = spr_robotnik_charge;         
        AnimationStart       = 0;
        AnimationEnd         = 7;
        AnimationLoop        = 0;
        AnimationSpeed       = 0.3;
